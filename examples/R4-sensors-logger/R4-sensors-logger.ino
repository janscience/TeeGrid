...
ControlPCM186x pcm3(Wire1, PCM186x_I2C_ADDR1, InputTDM::TDM2, InputTDM::DATA_A);
ControlPCM186x pcm4(Wire1, PCM186x_I2C_ADDR2, InputTDM::TDM2, InputTDM::DATA_A);
...
DiagnosticMenu diagnostic_menu(config, &pcm1, &pcm2, &pcm3, &pcm4,
                               &rtclock, &gpio);
